...
local function C_19c()
	...
	UILib.SavedScripts:Add("[DUELS] Murderers VS Sheriffs", "loadstring(game:HttpGet('https://raw.githubusercontent.com/Rysted/scripts/main/MurderersVSSheriffs.lua'))()", "Featured")
	UILib.SavedScripts:Add("Squid Game X", "loadstring(game:HttpGet('https://raw.githubusercontent.com/Rysted/scripts/main/SquidGameX.lua'))()", "Featured")
